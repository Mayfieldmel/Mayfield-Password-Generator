      ...
      if (confirmLowerCase) {
        ...
        if (confirmNumbers) {
          ...
          if (confirmSpecials) {
            ...
            var validateCriteria = window.confirm("You selected uppercase letters, lowercase letters, numbers and special characters. Press ok to confirm and receive your password, or cancel to exit and try again.")
            if (validateCriteria) {
              // randomize password
